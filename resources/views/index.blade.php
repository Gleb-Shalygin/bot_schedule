...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">Бот помощник</a>
    ...
    <section class="page-section bg-white text-secondary mb-0" id="about">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <p><a href="/documentation" class="text-secondary">
                        <i class="fa fa-book me-2"></i>
                        Документация
                    </a></p>
{{--                <a class="btn btn-xl text-secondary  btn-outline-muted" href="https://startbootstrap.com/theme/freelancer/">--}}
{{--                    <i class="fa fa-book me-2"></i>--}}
{{--                    Документация--}}
{{--                </a>--}}
            </div>
